...
/**
 * Repository de la classe GuideVoyage
 *
 */
...
public interface IGuideVoyageRepository extends JpaRepository<GuideVoyage, Integer> {
	// Récupère les guides de voyage par localisation
	...
	// Vérifie si un guide de voyage existe avec le nom donné
	...
	// Insère le nombre et la somme des notes pour un guide de voyage
	@Modifying
	...
	// Insère la note calculée pour un guide de voyage
	@Modifying
